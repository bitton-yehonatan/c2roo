...
def test_convert_skill_cleans_frontmatter():
    skill = Skill(name="pdf-processing", description="Extract PDFs", body="# Instructions\n\nDo stuff.",
        license="MIT", allowed_tools="Read Bash", disable_model_invocation=True, user_invocable=False,
        context="fork", agent="Explore", resources=[])
